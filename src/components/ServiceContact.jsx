...
const ServiceContact = () => {
  return (
    <div className="bg-[rgba(80,68,235,0.55)] shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-[11px] rounded-[20px] border border-[rgba(255,255,255,0.18)] p-12 m-4 flex flex-col gap-[4px] items-start ">
